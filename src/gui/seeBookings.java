 ...
 */
public class seeBookings extends javax.swing.JFrame {

    /**
     * Creates new form seeBookings
     */
    User user;
    public seeBookings() {
        initComponents();
    ...
    public seeBookings(User user)
    {
        ...
        try
        {
            ArrayList<Object[]> data=BookingsDao.getBookings(user);
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Username", "Name", "Mobile No.", "Email-Id", "Address", "Event Name", "Date Of Booking", "Date Of Event", "Time", "Amount", "Mode Of Payment"
            }
        ) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(seeBookings.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new seeBookings().setVisible(true);
            }
        });
    }
